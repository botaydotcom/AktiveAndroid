...
public class ImageCache {
    ...
    public static ImageCache getInstance(
        ...
        ImageCache imageCache = (ImageCache) mRetainFragment.getObject(cacheParams.diskCacheDirName);

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new ImageCache(cacheParams);
            mRetainFragment.setObject(cacheParams.diskCacheDirName, imageCache);
        }
    ...
    public static class ImageCacheParams {
        ...
        public String diskCacheDirName;
        ...
        public ImageCacheParams(Context context, String diskCacheDirectoryName) {
            ...
            diskCacheDirName = diskCacheDirectoryName;
        }
    ...
    public static class RetainFragment extends Fragment {
        private HashMap<String, Object> mObject;//mapCacheDirCache;
        private static final Object mLock = new Object();
        /**
         * Empty constructor as per the Fragment documentation
         */
        public RetainFragment() {
        	mObject = new HashMap<String, Object>(); //mapCacheDirCache
        }
         ...
         */
        public void setObject(String dirName,Object object) {
        	synchronized (mLock) {
        		mObject.put(dirName, object);
			}
        }
         ...
         */
        public Object getObject(String dirName) {
        	synchronized (mLock) {
            	return mObject.get(dirName);
        	}
        }
    }
